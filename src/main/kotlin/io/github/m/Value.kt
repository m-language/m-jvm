...
interface Value {
    ...
    @JvmDefault
    operator fun invoke(arg1: Value, arg2: Value) = this(arg1)(arg2)

    @JvmDefault
    operator fun invoke(arg1: Value, arg2: Value, arg3: Value) = this(arg1, arg2)(arg3)

    @JvmDefault
    operator fun invoke(arg1: Value, arg2: Value, arg3: Value, arg4: Value) = this(arg1, arg2, arg3)(arg4)

    @JvmDefault
    operator fun invoke(arg1: Value, arg2: Value, arg3: Value, arg4: Value, arg5: Value) = this(arg1, arg2, arg3, arg4)(arg5)
    ...
    class Impl4(val fn: (Value, Value, Value, Value) -> Value) : Value {
    ...
    class Impl5(val fn: (Value, Value, Value, Value, Value) -> Value) : Value {
